#!/usr/bin/env python3
"""
Fixed version of monitoring-setup.py
with corrected URL handling for health checks.
...
class SystemMonitor:
    ...
    def _check_api_health(self):
        ...
        # FIX: Properly construct the health URL to preserve port number
        # Method 1: Ensure no leading slash in the path
        health_url = urljoin(api_url, "health")  # No leading slash in "health"
        
        # Alternative Method 2: Simple string concatenation
        # health_url = f"{api_url}/health"
        
        # Alternative Method 3: URL parsing and reconstruction
