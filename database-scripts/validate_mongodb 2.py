...
mongodb_url = "os.environ.get('VALIDATE_MONGODB_SECRET')'VALIDATE_MONGODB_SECRET')'VALIDATE_MONGODB_SECRET')'VALIDATE_MONGODB_SECRET')"
mongodb_db_name = "eyewear_ml_dev"
...
try:
    ...
    print(f"\nFound {len(collections)} collections in database '{mongodb_db_name}':")
