...
interface SdkVersionSelectorProps {
  versions: Version[];
...
/**
 * SdkVersionSelector Component
 * 
 * A dropdown selector for choosing between different SDK versions.
 */
const SdkVersionSelector: React.FC<SdkVersionSelectorProps> = ({
  versions,
  currentVersion,
  onChange
}) => {
