/**
 * @fileoverview WooCommerce AI Discovery Chat API
 * Provides chat functionality with unified Dialogflow service integration
 * @module apps/woocommerce/api/chat
 */
...
router.use(cors({
  origin: process.env.WOOCOMMERCE_ALLOWED_ORIGINS?.split(',') || ['http://localhost:3000'],
  credentials: true
}));
...
router.post('/chat', async (req, res) => {
  try {
    ...
    console.error('WooCommerce Chat API Error:', error);
