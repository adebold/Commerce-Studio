/**
 * @fileoverview HTML Store AI Discovery Chat API
 * Provides chat functionality with unified Dialogflow service integration
 * @module apps/html-store/api/chat
 */
...
router.use(cors({
  origin: process.env.HTML_STORE_ALLOWED_ORIGINS?.split(',') || ['http://localhost:3000'],
  credentials: true
}));
...
router.post('/chat', async (req, res) => {
  try {
    ...
    console.error('HTML Store Chat API Error:', error);
