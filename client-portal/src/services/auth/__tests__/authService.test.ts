...
describe('authService', () => {
  ...
  describe('login', () => {
    it('should make a POST request to /auth/login with correct data', async () => {
      ...
      const loginData = { email: 'test@example.com', password: 'process.env.AUTHSERVICE_SECRET_1' };
  ...
  describe('register', () => {
    it('should make a POST request to /auth/register with correct data', async () => {
      ...
      const registerData = {
        ...
        password: 'process.env.AUTHSERVICE_SECRET_1'
      };
  ...
  describe('resetPassword', () => {
    it('should make a POST request to /auth/reset-password with token and password', async () => {
      ...
      await authService.resetPassword({ token: 'reset-token', password: 'process.env.AUTHSERVICE_SECRET_1_2' });
      
      expect(mockPost).toHaveBeenCalledWith('/auth/reset-password', {
        token: 'reset-token',
        password: 'process.env.AUTHSERVICE_SECRET_1_2'
      });
    });
  });
